...
public class DetailForm {
	...
	public DetailForm(String passportno, Date birthday, String institute, String studentid, String department,
	...
	public String toString() {
		return "DetailForm [passportno=" + passportno + ", birthday=" + birthday + ", institute=" + institute
